...
export default function index() {
    ...
    return (
        <BasedLayout>
                ...
                <div className="w-4/5 md:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="text-white z-10">
                        ...
                        <p className="my-9 text-base">
                            Menemukan keajaiban langit dan memecahkan misteri
                            mitos di satu tempat, petualangan luar biasa
                            melintasi tata surya dan jauh ke angkasa.
                        </p>
                    ...
                    <div className="flex justify-center items-center order-first lg:order-none">
                        <img
                            className="w-96 animate-[hero_5s_linear_infinite]"
                            src={hero}
                            alt=""
                        />
                    </div>
            ...
            <section
                id="homeExplore"
                className="homeExplore flex justify-center py-12 md:py-16 relative"
            >
                <div className="w-4/5 md:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="text-white z-10">
                        ...
                        <p className="my-9 text-base">
                            Mari kita mulai petualangan kita di alam semesta
                            yang luas. Kamu akan menemukan pintu gerbang menuju
                            eksplorasi tata surya yang menakjubkan. Siapkan
                            dirimu untuk terpesona oleh keindahan dan misteri
                            planet-planet, bulan, dan benda langit lainnya yang
                            menghiasi langit malam kita.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section
                id="homeSources"
                className="homeSources flex justify-center py-12 md:py-16 relative"
            >
                <div className="w-4/5 md:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="text-white z-10">
                        <h1 className="font-magmawave text-3xl md:text-4xl lg:text-5xl bg-gradient-to-r from-based-2 to-based-3 inline-block text-transparent bg-clip-text">
                        ...
                        <p className="my-9 text-base">
                            Dengan panduan para ahli astronomi dan sains, kami
                            membawa Anda dalam perjalanan yang mendebarkan
                            melintasi galaksi, memecahkan misteri mitos lama,
                            dan menjelajahi rahasia yang tersembunyi di antara
                            bintang-bintang.
                        </p>
                    </div>
                    <div className="flex justify-center items-center order-first lg:order-none z-10">
            ...
            <section
                id="homePopular"
                className="homePopular flex flex-col justify-center py-12 md:py-16 relative items-center"
            >
                <div className="text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8">
                    ...
                    <p className="text-base mb-16">
                        Yuk, kita cek apa yang sebenarnya terjadi di balik
                        cerita-cerita langit yang sering kita dengar. Apakah
                        benar bintang jatuh itu keinginan yang dikabulkan?
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 z-10">
                        <Card
                            ...
                            category={"Astronomi"}
                            title={
                                "Saturnus: Cincin dan Masa Lalu yang Tersembunyi"
                            }
                            description={
                                "Telusuri rahasia tersembunyi di balik cincin yang memukau serta menjelajahi jejak masa lalu planet gas raksasa yang penuh teka-teki ini."
                            }
                        />
                        <Card
                            link={"/topic"}
                            ...
                            description={
                                "Jelajahi misteri dan keindahan planet Mars, planet merah yang penuh dengan rahasia dan potensi penelitian masa depan."
                            }
                        />
                        <Card
                            link={"/topic"}
                            ...
                            description={
                                "Bagaimana pengetahuan modern kita mengenai dua benda langit ini memengaruhi keyakinan dan cerita-cerita kuno."
                            }
                        />
                    </div>
                </div>
