...
export default function index() {
    return (
        <BasedLayout>
            <img className='absolute top-0 -z-0' src={deco1} alt="" />
            <img className='absolute top-0 -z-0' src={background} alt="" />
            <img className='absolute top-0 -z-0' src={background2} alt="" />
            <img className='absolute top-[30%] -z-0' src={background} alt="" />
            <img className='absolute top-[30%] -z-0' src={background2} alt="" />

            <div className="absolute w-96 h-96 -top-20 -right-20 bg-white/10 rounded-full blur-2xl -z-0"></div>

            <section id='hero' className='hero flex justify-center py-12 md:py-28 xl:pt-20 xl:pb-36 relative'>
            ...
            <section id='explore' className='explore flex justify-center py-12 md:py-20 xl:pt-20 xl:pb-36 relative'>
                <div className="w-4/5 md:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className='flex justify-center items-center order-first lg:order-none'>
            ...
            <section id='sources' className='sources flex justify-center py-12 md:py-20 xl:pt-20 xl:pb-36 relative'>
                <div className="w-4/5 md:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className='text-white'>
            ...
            <section id='popular' className='popular flex flex-col justify-center py-12 md:py-20 xl:pt-20 xl:pb-36 relative items-center'>
                <div className='text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8'>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        <Card image={saturnus} category={'Astronomi'} title={'Saturnus: Cincin dan Masa Lalu yang Tersembunyi'} description={'Telusuri rahasia tersembunyi di balik cincin yang memukau serta menjelajahi jejak masa lalu planet gas raksasa yang penuh teka-teki ini.'} />
                        <Card image={mars} category={'Astronomi'} title={'Mars: Planet Merah yang Menarik'} description={'Jelajahi misteri dan keindahan planet Mars, planet merah yang penuh dengan rahasia dan potensi penelitian masa depan.'} />
                        <Card image={gerhana} category={'Mitos / fakta ?'} title={'Matahari dan Bulan: Legenda di Balik Sinar'} description={'Bagaimana pengetahuan modern kita mengenai dua benda langit ini memengaruhi keyakinan dan cerita-cerita kuno.'} />
                    </div>
                </div>
            </section>

            <section id='hubungi' className='hubungi flex flex-col justify-center py-12 md:py-20 xl:pt-20 xl:pb-36 relative items-center'>
                <div className='text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8 z-10'>
                    <h1 className='font-magmawave text-3xl md:text-4xl lg:text-5xl bg-gradient-to-r from-based to-based-1 inline-block text-transparent bg-clip-text'>hubungi kami</h1>
                    <p className='text-base mb-8'>Memiliki pertanyaan? ingin bekerja sama dengan kami? hubungi kami sekarang juga!</p>
                    <div className='flex flex-col justify-center items-center text-center'>
