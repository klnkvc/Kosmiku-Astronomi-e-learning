        ...
        <BasedLayout>
            <section id='login' className='login flex flex-col justify-center py-12 md:py-16 relative items-center'>
                <div className='text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8 z-10'>
                    ...
                    <p className='text-base md:text-2xl font-bold mb-16 bg-gradient-to-r from-based-2 to-based-3 inline-block text-transparent bg-clip-text'>Login untuk mendapatkan notifikasi berita terbaru !</p>
                </div>
                            ...
                            <div className="md:mx-20 flex flex-col gap-5">
                                ...
                                <div className="flex flex-col lg:flex-row gap-3 justify-between">
                                    <div class="inline-flex items-center">
                                        ...
                                        <label class="mt-px font-medium text-sm md:text-base text-white cursor-pointer select-none" htmlFor="check">
                                            Remember Me
                                        </label>
                                    </div>
                                    <p className='text-white text-center text-sm md:text-base'>Tidak punya akun? <span><Link className='text-based-1' to={'/register'}>Register Here</Link></span></p>
                                </div>
                            </div>
                        </form>
