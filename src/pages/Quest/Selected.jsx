                            ...
                            <div className="relative">
                                ...
                                <form action="">
                                    ...
                                    <div className="flex flex-col my-8 gap-4 md:gap-8">
                                        <div className="py-4 border-4 border-quest-1 rounded-[360px] w-full lg:w-1/2 m-auto text-xl lg:text-2xl font-bold text-white text-center">Bumi</div>
                                        <div className="py-4 border-4 border-quest-1 bg-rightSelected rounded-[360px] w-full lg:w-1/2 m-auto text-xl lg:text-2xl font-bold text-white text-center">Jupiter</div>
                                        <div className="py-4 border-4 border-quest-1 bg-wrongSelected rounded-[360px] w-full lg:w-1/2 m-auto text-xl lg:text-2xl font-bold text-white text-center">Saturnus</div>
                                        <div className="py-4 border-4 border-quest-1 rounded-[360px] w-full lg:w-1/2 m-auto text-xl lg:text-2xl font-bold text-white text-center">Merkurius</div>
                                    </div>
                                    ...
                                    <div className="flex justify-center mt-8">
                                        <Link to={'/quest/score'} className='rounded-[360px] w-full lg:w-1/2 bg-quest-1 py-4 text-center text-lg lg:text-2xl font-bold text-white hover:bg-gradient-to-r hover:from-based hover:to-based-1'>SELANJUTNYA</Link>
                                    </div>
                                </form>
                            </div>
                        </div>
