        ...
        <BasedLayout>
            ...
            <section id='astronomi' className='astronomi flex flex-col justify-center py-12 md:py-16 relative items-center'>
                <div className='text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8'>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <Card link={'/topic'} type={'materi'} image={gerhana} category={'Astronomi'} title={'Matahari dan Bulan: Legenda di Balik Sinar'} description={'Bagaimana pengetahuan modern kita mengenai dua benda langit ini memengaruhi keyakinan dan cerita-cerita kuno.'} />
                    </div>
                </div>
            </section>
            ...
            <section id='mitos' className='mitos flex flex-col justify-center py-12 md:py-16 relative items-center'>
                <div className='text-white text-center w-4/5 md:w-3/4 grid grid-cols-1 gap-8'>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        <Card link={'/topic'} type={'materi'} image={saturnus} category={'Mitos / Fakta ?'} title={'Saturnus: Cincin dan Masa Lalu yang Tersembunyi'} description={'Telusuri rahasia tersembunyi di balik cincin yang memukau serta menjelajahi jejak masa lalu planet gas raksasa yang penuh teka-teki ini.'} />
                        <Card link={'/topic'} type={'materi'} image={mars} category={'Mitos / Fakta ?'} title={'Mars: Planet Merah yang Menarik'} description={'Jelajahi misteri dan keindahan planet Mars, planet merah yang penuh dengan rahasia dan potensi penelitian masa depan.'} />
