        ...
        <div className="relative">
          ...
          {category === "Astronomi" ? (
            <div className="absolute top-0 left-1/2 ml-[-80px] w-40 h-[40px] bg-gradient-to-r from-category-1 to-category-2 rounded-b-[53px]">
              <p className="text-white text-center py-2 text-md italic">{category}</p>
            </div>
          ) : (
          ...
          <h3 className="text-xl text-white font-bold text-left mt-4 line-clamp-2 max-w-full">{title}</h3>
        </div>
      </div>
    </div>
  );
